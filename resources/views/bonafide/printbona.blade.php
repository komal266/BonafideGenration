    ...
    <div class="text-blue-900">
        ...
        <hr class="border-black w-[50%] mx-auto mt-2"/>
          ...
          <div class="text-lg w-[50%] mx-auto">
            <div> &emsp; &emsp; &ensp; This is to certify that Mast/Miss___________________is a</div> student of our school studying in Grade___Div.___in the academic year 202&emsp;-202&emsp; . His / Her date of birth as oer our school record is &emsp;/ &emsp;/
            <div class="mt-4">(in words_______________________________). Place of birth___________Caste___________to the best of my knowledge, he/she bears a good moral character.</div>
              </div>
