...
<div class="card">
    ...
    <div class="card-body">
        <table id="applications_table" class="table table-sm table-responsive">
            <colgroup>
                <col style="width: 5%">
                <col style="width: 20%;">
                <col style="width: 15%;">
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            <thead>
                                ...
                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 bold-black">Div</th>
                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 bold-black">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
